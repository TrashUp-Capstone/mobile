 ...
 * Use the [PickupDriverFragment.newInstance] factory method to
...
class PickupDriverFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pickup_driver, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment PickupDriverFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PickupDriverFragment().apply {
