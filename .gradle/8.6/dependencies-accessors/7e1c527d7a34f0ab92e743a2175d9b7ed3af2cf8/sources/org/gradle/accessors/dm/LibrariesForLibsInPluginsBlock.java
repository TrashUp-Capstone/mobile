...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLifecycleLivedataKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v270</b> with <b>androidx.lifecycle:lifecycle-livedata-ktx</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV270() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.lifecycle.livedata.ktx.v270");
        }
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
        private final PlayServicesTfliteLibraryAccessors laccForPlayServicesTfliteLibraryAccessors = new PlayServicesTfliteLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>play.services.tflite</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public PlayServicesTfliteLibraryAccessors getTflite() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForPlayServicesTfliteLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class PlayServicesTfliteLibraryAccessors extends SubDependencyFactory {
        private final PlayServicesTfliteAccelerationLibraryAccessors laccForPlayServicesTfliteAccelerationLibraryAccessors = new PlayServicesTfliteAccelerationLibraryAccessors(owner);

        public PlayServicesTfliteLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>play.services.tflite.acceleration</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public PlayServicesTfliteAccelerationLibraryAccessors getAcceleration() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForPlayServicesTfliteAccelerationLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class PlayServicesTfliteAccelerationLibraryAccessors extends SubDependencyFactory {

        public PlayServicesTfliteAccelerationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>service</b> with <b>com.google.android.gms:play-services-tflite-acceleration-service</b> coordinates and
         * with version reference <b>playServicesTfliteAccelerationService</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getService() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("play.services.tflite.acceleration.service");
        }
    ...
    public static class TensorflowLiteLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>tensorflow.lite.select</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class TensorflowLiteMetadataLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v044</b> with <b>org.tensorflow:tensorflow-lite-metadata</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV044() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.lite.metadata.v044");
        }
    ...
    public static class TensorflowLiteSelectLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>tensorflow.lite.select.tf</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class TensorflowLiteSelectTfLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>ops</b> with <b>org.tensorflow:tensorflow-lite-select-tf-ops</b> coordinates and
         * with version reference <b>tensorflowLiteSelectTfOps</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class TensorflowLiteSupportLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v044</b> with <b>org.tensorflow:tensorflow-lite-support</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV044() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.lite.support.v044");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>cameraxVersion</b> with value <b>1.2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleLivedataKtxVersion</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesTfliteAccelerationService</b> with value <b>16.0.0-beta01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayServicesTfliteAccelerationService() { return getVersion("playServicesTfliteAccelerationService"); }
        ...
        /**
         * Version alias <b>tensorflowLiteMetadataVersion</b> with value <b>0.4.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tensorflowLiteSelectTfOps</b> with value <b>2.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTensorflowLiteSelectTfOps() { return getVersion("tensorflowLiteSelectTfOps"); }
        ...
        /**
         * Version alias <b>tensorflowLiteSupportVersion</b> with value <b>0.4.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
